...
fit_params_old = fit_parameters(get_independent_variables_and_relative_intensities(v1_45), p0=[0.7,1.2,.1], 
	average_angle=0, precision=-1, use_errs=True, use_spike=False)
chi_squared_old = chi_squared(v1_45.independent_variables_array, v1_45.relative_intensities, v1_45.relative_std, fit_params_old, average_angle=0, precision=-1)

fit_params_new = fit_parameters_grid(get_independent_variables_and_relative_intensities(v1_45),
	...
	rho_start=0.55, rho_end=0.85, rho_num=21, n_start=1.2, n_end=1.4, n_num=21, gamma_start=0.05, gamma_end=0.3, gamma_num=21, plot=True, show=False) # coarse

chi_squared_new = chi_squared(v1_45.independent_variables_array, v1_45.relative_intensities, v1_45.relative_std, fit_params_new, average_angle=0, precision=-1)
